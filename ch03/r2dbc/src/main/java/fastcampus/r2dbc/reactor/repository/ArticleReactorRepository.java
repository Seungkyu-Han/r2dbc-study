package fastcampus.r2dbc.reactor.repository;


import fastcampus.r2dbc.common.repository.ArticleEntity;
...
public class ArticleReactorRepository {
    ...
    @SneakyThrows
    public Flux<ArticleEntity> findAllByUserId(Long userId) {
